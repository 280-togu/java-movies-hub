...
public class MoviesApiTest {
    ...
    void postMovies_whenValidMovie_returnsCreatedMovie() throws Exception {
        HttpRequest request = HttpRequest.newBuilder().uri(URI.create(BASE + "/movies")).header("Content-Type", "application/json").POST(HttpRequest.BodyPublishers.ofString("{\"title\":\"Начало\",\"director\":\"Кристофер Нолан\",\"year\":2010}")).build();
    ...
    void postMovies_whenTitleIsEmpty_returns422() throws Exception {
        HttpRequest request = HttpRequest.newBuilder().uri(URI.create(BASE + "/movies")).header("Content-Type", "application/json").POST(HttpRequest.BodyPublishers.ofString("{\"title\":\"\",\"director\":\"Кристофер Нолан\",\"year\":2010}")).build();
    ...
    void postMovies_whenTitleTooLong_returns422() throws Exception {
        ...
        HttpRequest request = HttpRequest.newBuilder().uri(URI.create(BASE + "/movies")).header("Content-Type", "application/json").POST(HttpRequest.BodyPublishers.ofString("{\"title\":\"" + longTitle + "\",\"director\":\"Кристофер Нолан\",\"year\":2010}")).build();
    ...
    void postMovies_whenYearTooEarly_returns422() throws Exception {
        HttpRequest request = HttpRequest.newBuilder().uri(URI.create(BASE + "/movies")).header("Content-Type", "application/json").POST(HttpRequest.BodyPublishers.ofString("{\"title\":\"Начало\",\"director\":\"Кристофер Нолан\",\"year\":1887}")).build();
    ...
    void postMovies_whenYearTooLate_returns422() throws Exception {
        HttpRequest request = HttpRequest.newBuilder().uri(URI.create(BASE + "/movies")).header("Content-Type", "application/json").POST(HttpRequest.BodyPublishers.ofString("{\"title\":\"Начало\",\"director\":\"Кристофер Нолан\",\"year\":2028}")).build();
    ...
    void postMovies_whenContentTypeIsWrong_returns415() throws Exception {
        HttpRequest request = HttpRequest.newBuilder().uri(URI.create(BASE + "/movies")).header("Content-Type", "text/plain").POST(HttpRequest.BodyPublishers.ofString("{\"title\":\"Начало\",\"director\":\"Кристофер Нолан\",\"year\":2010}")).build();
    ...
    void postMovies_whenJsonIsInvalid_returns422() throws Exception {
        HttpRequest request = HttpRequest.newBuilder().uri(URI.create(BASE + "/movies")).header("Content-Type", "application/json").POST(HttpRequest.BodyPublishers.ofString("{\"title\":\"Начало\",\"year\":")).build();
    ...
    void postMovies_whenTitleTooLong_returnsValidationError() throws Exception {
        ...
        HttpRequest request = HttpRequest.newBuilder().uri(URI.create(BASE + "/movies")).header("Content-Type", "application/json").POST(HttpRequest.BodyPublishers.ofString("{\"title\":\"" + title + "\",\"director\":\"Кристофер Нолан\",\"year\":2010}")).build();
    ...
    void getMovieById_whenMovieExists_returnsMovie() throws Exception {
        Movie movie = new Movie("Начало", "Кристофер Нолан", 2010);

        store.addMovie(movie);

        HttpRequest request = HttpRequest.newBuilder().uri(URI.create(BASE + "/movies/" + movie.getId())).GET().build();
    ...
    void deleteMovie_whenMovieExists_returns204() throws Exception {
        ...
        HttpRequest request = HttpRequest.newBuilder().uri(URI.create(BASE + "/movies/" + movie.getId())).DELETE().build();
    ...
    void getMoviesByYear_whenMoviesExist_returnsMoviesOfGivenYear() throws Exception {
        ...
        HttpRequest request = HttpRequest.newBuilder().uri(URI.create(BASE + "/movies?year=2010")).GET().build();
    ...
    void addMovie_withoutContentType_returnsUnsupportedMediaType() throws Exception {
        ...
        HttpRequest request = HttpRequest.newBuilder().uri(URI.create(BASE + "/movies")).POST(HttpRequest.BodyPublishers.ofString(json, StandardCharsets.UTF_8)).build();
    ...
    void addMovie_withContentTypeAndCharset_returnsCreated() throws Exception {
        ...
        HttpRequest request = HttpRequest.newBuilder().uri(URI.create(BASE + "/movies")).header("Content-Type", "application/json; charset=UTF-8").POST(HttpRequest.BodyPublishers.ofString(json, StandardCharsets.UTF_8)).build();
    ...
    void deleteMovie_withoutId_returnsBadRequest() throws Exception {
        HttpRequest request = HttpRequest.newBuilder().uri(URI.create(BASE + "/movies")).DELETE().build();
